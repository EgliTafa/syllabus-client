...
export const CreateCourse = () => {
  ...
  const { syllabusList, isFetching: isFetchingSyllabuses } =
    useGetAllSyllabuses();
    ...
    try {
      ...
      const courseData: CreateCourseRequest = {
        ...
        detail: {
          ...
          credits:
            parseInt(formData.detailCredits) || parseInt(formData.credits) || 0,
          teachingPlan: {
            lectureHours:
              parseInt(formData.tpLectureHours) ||
              parseInt(formData.lectureHours) ||
              0,
            labHours:
              parseInt(formData.tpLabHours) || parseInt(formData.labHours) || 0,
            practiceHours:
              parseInt(formData.tpPracticeHours) ||
              parseInt(formData.practiceHours) ||
              0,
            exerciseHours: parseInt(formData.tpExerciseHours) || 0,
            weeklyHours: parseInt(formData.tpWeeklyHours) || 0,
            individualStudyHours:
              parseInt(formData.tpIndividualStudyHours) || 0,
          },
          evaluationBreakdown: {
